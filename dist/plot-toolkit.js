...
eval("module.exports = \"<div>\\n<canvas style=\\\"margin: {{self.paddingStr();}};width:calc(100% - {{self.leftPadding()}}px); height:calc(100% - {{self.bottomPadding()}}px)\\\">\\n</canvas>\\n</div>\\n\\n\";\n\n//# sourceURL=webpack:///./scatter-layer/template.html?");
