...
/***/ "../node_modules/css-loader/dist/cjs.js!./layer-array/style.css":
/*!**********************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js!./layer-array/style.css ***!
  \**********************************************************************/
/*! no static exports found */
...
eval("exports = module.exports = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"../node_modules/css-loader/dist/runtime/api.js\")(false);\n// Module\nexports.push([module.i, \"layer-array div.toggle-btn {\\n    padding: 5px;\\n    text-align: center;\\n    display: inline-block;\\n    border-width: 3px;\\n    border-style: outset;\\n    background-color: #fff;\\n    cursor:pointer;\\n}\\nlayer-array div.toggle-btn.pressed {\\n    border-style: inset;\\n    background-color: #eee;\\n}\\n\\nlayer-array .form-holder {\\n    background-color: #ccc;\\n    color: #fff;\\n    border-style: outset;\\n    border-width: 3px;\\n    position: absolute;\\n    top: 50%;\\n    left: 50%;\\n    transform: translate(-50%, -50%);\\n    padding: 15px;\\n}\\n\\nlayer-array .form-group {\\n    margin: 0 5px 10px;\\n}\\n\\nlayer-array .form-group input[type=\\\"number\\\"],\\nlayer-array .form-group input[type=\\\"text\\\"]\\n{\\n    width: 100%;\\n}\\n\\nlayer-array label {\\n    margin-right: 10px;\\n    display: block;\\n}\\n\\nlayer-array div.title {\\n    text-transform: uppercase;\\n    margin: 0 0 10px;\\n    text-align: center;\\n    border-bottom: 1px solid #fff;\\n}\\n\", \"\"]);\n\n\n\n//# sourceURL=webpack:///./layer-array/style.css?../node_modules/css-loader/dist/cjs.js");
...
/***/ "../node_modules/css-loader/dist/cjs.js!./layer-wrapper/style.css":
/*!************************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js!./layer-wrapper/style.css ***!
  \************************************************************************/
/*! no static exports found */
...
eval("exports = module.exports = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"../node_modules/css-loader/dist/runtime/api.js\")(false);\n// Module\nexports.push([module.i, \"\", \"\"]);\n\n\n\n//# sourceURL=webpack:///./layer-wrapper/style.css?../node_modules/css-loader/dist/cjs.js");
...
eval("const moduleName = 'plot-toolkit';\nconst name = 'layerArray';\nmodule.exports.name = name;\n__webpack_require__(/*! ./style.css */ \"./layer-array/style.css\");\n\nangular.module(moduleName)\n    .component(name, {\n        controller: LayerArrayController,\n        controllerAs: 'self',\n        template: __webpack_require__(/*! ./template.html */ \"./layer-array/template.html\"),\n        bindings: {\n            commonConfig: \"<\", \n            layers: \"<\"\n        }\n    });\n\nfunction LayerArrayController($timeout, $element, $scope) {\n    let self = this;\n    this.$onInit = function() {\n        this.commonConfig = this.commonConfig || { };\n        this.commonConfig.minVal = this.commonConfig.minVal || 0;\n        this.commonConfig.maxVal = this.commonConfig.maxVal || 1;\n        this.commonConfig.minY = this.commonConfig.minY || 0;\n        this.commonConfig.maxY = this.commonConfig.maxY || 1;\n\n        this.layers = this.layers || [];\n    }\n    this.addPolygonLayer = function(points, color) {\n        console.log('add Polygon Layer', color);\n    }\n    this.addLineFormulaLayer = function(formula, color) {\n        console.log('add LineFormular Layer');\n        self.layers.push({\n            type: 'lineFormulaLayer',\n            minVal: self.commonConfig.minVal,\n            maxVal: self.commonConfig.maxVal,\n            minY: self.commonConfig.minY,\n            maxY: self.commonConfig.maxY,\n            formula: angular.copy(formula),\n            eqnOffsets:['55px', '300%'],\n            showEquation: true,\n            lineColor:color\n        });\n    }\n    this.addLayer = function() {\n        console.log(\"add formula layer\");\n        self.layers.push({\n            type: 'lineFormulaLayer',\n            minVal: self.commonConfig.minVal,\n            maxVal: self.commonConfig.maxVal,\n            minY: self.commonConfig.minY,\n            maxY: self.commonConfig.maxY,\n            formula: {family:'power', coefficient: 0.05, exponent: 2},\n            eqnOffsets:['55px', '300%'],\n            showEquation: true,\n            lineColor:'brown'\n        });\n    }\n}\n\n\n//# sourceURL=webpack:///./layer-array/index.js?");

/***/ }),

/***/ "./layer-array/style.css":
/*!*******************************!*\
  !*** ./layer-array/style.css ***!
  \*******************************/
/*! no static exports found */
...
eval("\nvar content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./style.css */ \"../node_modules/css-loader/dist/cjs.js!./layer-array/style.css\");\n\nif(typeof content === 'string') content = [[module.i, content, '']];\n\nvar transform;\nvar insertInto;\n\n\n\nvar options = {\"hmr\":true}\n\noptions.transform = transform\noptions.insertInto = undefined;\n\nvar update = __webpack_require__(/*! ../../node_modules/style-loader/lib/addStyles.js */ \"../node_modules/style-loader/lib/addStyles.js\")(content, options);\n\nif(content.locals) module.exports = content.locals;\n\nif(false) {}\n\n//# sourceURL=webpack:///./layer-array/style.css?");

/***/ }),

/***/ "./layer-array/template.html":
/*!***********************************!*\
  !*** ./layer-array/template.html ***!
  \***********************************/
/*! no static exports found */
...
eval("module.exports = \"<layer-wrapper ng-repeat='layer in self.layers' \\n    layer-type=\\\"layer.type\\\" \\n    layer-config=\\\"layer\\\">\\n</layer-wrapper>\\n<span class=\\\"control-toolbar\\\">\\n    <div class=\\\"toggle-btn\\\" ng-click='addingMode=\\\"addingPolygonLayer\\\"'>\\n        <span class=\\\"ti-plus\\\"></span>\\n    </div>\\n    <div class=\\\"toggle-btn\\\" ng-click='addingMode=\\\"addingLineFormulaLayer\\\"'>\\n        <span class=\\\"ti-menu-alt\\\"></span>\\n    </div>\\n</span>\\n\\n<div class=\\\"form-holder\\\" ng-show=\\\"addingMode === 'addingPolygonLayer'|| addingMode === 'addingLineFormulaLayer'\\\">\\n    <form ng-show=\\\"addingMode === 'addingPolygonLayer'\\\" ng-submit=\\\"self.addPolygonLayer(points, color);addingMode=null;\\\">\\n        <div class=\\\"title\\\">Add Polygon</div>\\n        <div class=\\\"form-group\\\">\\n            <input type=\\\"text\\\" ng-model=\\\"points\\\" placeholder=\\\"enter points\\\">\\n        </div>\\n        <div class=\\\"form-group\\\">\\n        <input type=\\\"color\\\" ng-model=\\\"color\\\">\\n            <input style=\\\"width:0px;height:0px;padding:0;border:none\\\" type=\\\"submit\\\" value=\\\"ok\\\">\\n        </div>\\n        <div class=\\\"form-group\\\">\\n            <input style=\\\"float:right\\\" type=\\\"button\\\" ng-click=\\\"addingMode = null\\\" value=\\\"Cancel\\\">\\n        </div>\\n    </form>\\n    <form ng-show=\\\"addingMode === 'addingLineFormulaLayer'\\\" ng-submit=\\\"self.addLineFormulaLayer(formula,color1);addingMode=null\\\">\\n        <div class=\\\"title\\\">Add Line Formula</div>\\n        <div class=\\\"form-group\\\">\\n            <label>\\n                <input type=\\\"radio\\\" name=\\\"family\\\" ng-model=\\\"formula.family\\\" value=\\\"linear\\\">\\n                <katex-view latex-content=\\\"'y = A \\\\\\\\times x + B'\\\"></katex-view>\\n            </label>\\n            <label>\\n                <input type=\\\"radio\\\" name=\\\"family\\\" ng-model=\\\"formula.family\\\" value=\\\"exponential\\\">\\n                <katex-view latex-content=\\\"'y = Ae^{Bx}'\\\"></katex-view>\\n                \\n            </label>\\n            <label>\\n                <input type=\\\"radio\\\" name=\\\"family\\\" ng-model=\\\"formula.family\\\" value=\\\"power\\\">\\n                <katex-view latex-content=\\\"'y = Ax^B'\\\"></katex-view>\\n            </label>\\n        </div>\\n        <div ng-show=\\\"formula.family === 'linear'\\\">\\n            <div class=\\\"form-group\\\">\\n                <input type=\\\"number\\\" ng-model=\\\"formula.slope\\\" step=\\\"0.001\\\" placeholder=\\\"slope\\\">\\n            </div>\\n            <div class=\\\"form-group\\\">\\n                <input type=\\\"number\\\" ng-model=\\\"formula.intercept\\\" step=\\\"0.001\\\" placeholder=\\\"intercept\\\">\\n            </div>\\n        </div>\\n        <div ng-show=\\\"formula.family === 'exponential'\\\">\\n            <div class=\\\"form-group\\\">\\n                <input type=\\\"number\\\" ng-model=\\\"formula.ae\\\" step=\\\"0.001\\\" placeholder=\\\"a\\\">\\n            </div>\\n            <div class=\\\"form-group\\\">\\n                <input type=\\\"number\\\" ng-model=\\\"formula.b\\\" step=\\\"0.001\\\" placeholder=\\\"b\\\">\\n            </div>\\n        </div>\\n        <div ng-show=\\\"formula.family === 'power'\\\">\\n            <div class=\\\"form-group\\\">\\n                <input type=\\\"number\\\" ng-model=\\\"formula.coefficient\\\" step=\\\"0.001\\\" placeholder=\\\"coefficient\\\">\\n            </div>\\n            <div class=\\\"form-group\\\">\\n                <input type=\\\"number\\\" ng-model=\\\"formula.exponent\\\" step=\\\"0.001\\\" placeholder=\\\"exponent\\\">\\n            </div>\\n        </div>\\n        <div class=\\\"form-group\\\">\\n            <input type=\\\"color\\\" ng-model=\\\"color1\\\">\\n        </div>\\n        <input style=\\\"width:0px;height:0px;padding:0;border:none\\\" type=\\\"submit\\\" value=\\\"ok\\\">\\n        <input style=\\\"float:right\\\" type=\\\"button\\\" ng-click=\\\"addingMode = null\\\" value=\\\"Cancel\\\">\\n    </form>\\n</div>\\n\";\n\n//# sourceURL=webpack:///./layer-array/template.html?");
...
eval("const moduleName = 'plot-toolkit';\nconst name = 'layerWrapper';\nmodule.exports.name = name;\n__webpack_require__(/*! ./style.css */ \"./layer-wrapper/style.css\");\n\nangular.module(moduleName)\n    .component(name, {\n        controller: LayerWrapperController,\n        controllerAs: 'self',\n        template: __webpack_require__(/*! ./template.html */ \"./layer-wrapper/template.html\"),\n        bindings: {\n            layerType: \"<\",\n            layerConfig: \"<\"\n        }\n    });\n\nfunction LayerWrapperController($timeout, $element, $scope) {\n    let self = this;\n    this.$onInit = function() {\n        self.layerType = self.layerType || \"polygonLayer\";\n        self.layerConfig = self.layerConfig || {\n            minVal: 0,\n            maxVal: 1,\n            minY: 0,\n            maxY: 1,\n            points: [{x:1, y:0}, {x:0, y:1}],\n            mode: 0\n        }\n    }\n}\n\n\n//# sourceURL=webpack:///./layer-wrapper/index.js?");

/***/ }),

/***/ "./layer-wrapper/style.css":
/*!*********************************!*\
  !*** ./layer-wrapper/style.css ***!
  \*********************************/
/*! no static exports found */
...
eval("\nvar content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./style.css */ \"../node_modules/css-loader/dist/cjs.js!./layer-wrapper/style.css\");\n\nif(typeof content === 'string') content = [[module.i, content, '']];\n\nvar transform;\nvar insertInto;\n\n\n\nvar options = {\"hmr\":true}\n\noptions.transform = transform\noptions.insertInto = undefined;\n\nvar update = __webpack_require__(/*! ../../node_modules/style-loader/lib/addStyles.js */ \"../node_modules/style-loader/lib/addStyles.js\")(content, options);\n\nif(content.locals) module.exports = content.locals;\n\nif(false) {}\n\n//# sourceURL=webpack:///./layer-wrapper/style.css?");

/***/ }),

/***/ "./layer-wrapper/template.html":
/*!*************************************!*\
  !*** ./layer-wrapper/template.html ***!
  \*************************************/
/*! no static exports found */
...
eval("module.exports = \"<polygon-layer \\n    ng-if=\\\"self.layerType === 'polygonLayer'\\\"\\n    min-val=\\\"self.layerConfig.minVal\\\"\\n    max-val=\\\"self.layerConfig.maxVal\\\" \\n    min-y=\\\"self.layerConfig.minY\\\"\\n    max-y=\\\"self.layerConfig.maxY\\\"\\n    loga=\\\"self.layerConfig.loga\\\"\\n    ortho-loga=\\\"self.layerConfig.orthoLoga\\\"\\n    points=\\\"self.layerConfig.points\\\"\\n    mode=\\\"self.layerConfig.mode\\\"\\n></polygon-layer>\\n<line-formula-layer\\n    ng-if=\\\"self.layerType === 'lineFormulaLayer'\\\"\\n    min-val=\\\"self.layerConfig.minVal\\\"\\n    max-val=\\\"self.layerConfig.maxVal\\\" \\n    min-y=\\\"self.layerConfig.minY\\\"\\n    max-y=\\\"self.layerConfig.maxY\\\"\\n    loga=\\\"self.layerConfig.loga\\\"\\n    ortho-loga=\\\"self.layerConfig.orthoLoga\\\"\\n    formula=\\\"self.layerConfig.formula\\\"\\n    eqn-offsets=\\\"self.layerConfig.eqnOffsets\\\"\\n    show-equation=\\\"self.layerConfig.showEquation\\\"\\n    line-color=\\\"self.layerConfig.lineColor\\\"\\n></line-formula-layer>\\n<segment-layer\\n    ng-if=\\\"self.layerType === 'segmentLayer'\\\"\\n    min-val=\\\"self.layerConfig.minVal\\\"\\n    max-val=\\\"self.layerConfig.maxVal\\\" \\n    min-y=\\\"self.layerConfig.minY\\\"\\n    max-y=\\\"self.layerConfig.maxY\\\"\\n    loga=\\\"self.layerConfig.loga\\\"\\n    ortho-loga=\\\"self.layerConfig.orthoLoga\\\"\\n    points=\\\"self.layerConfig.points\\\"\\n    mode=\\\"self.layerConfig.mode\\\"\\n    eqn-offsets=\\\"self.layerConfig.eqnOffsets\\\"\\n    stroke-style=\\\"self.layerConfig.strokeStyle\\\"\\n></segment-layer>\\n\";\n\n//# sourceURL=webpack:///./layer-wrapper/template.html?");
